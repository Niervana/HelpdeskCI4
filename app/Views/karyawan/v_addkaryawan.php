            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= site_url('karyawan') ?>" method="post" autocomplete="off" id="myForm">
                                <?= csrf_field() ?>
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="id_karyawan" pattern="[0-9]{4}" maxlength="4" class="form-control form-check-inline col-md-3" required>
                                        <input type="text" name="nik_karyawan" pattern="[0-9]{16}" maxlength="16" class="form-control form-check-inline col-md-6" required>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label>contact</label>
                                    <input type="number" name="nomor_telp" pattern="[0-9]+" class="form-control">
                                </div>
                        ...
                        <div class="card-body col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="salary" id="salary" class="form-control currency">
                                </div>
                            </div>
                            <div class="form-group">
