            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="<?= site_url('karyawan' . $karyawan->id_tetap) ?>" method="post" autocomplete="off" id="myForm">
                                <?= csrf_field() ?>
                                <input type="hidden" name="_method" value="PUT">
                                <label>ID Karyawan*</label> &emsp;&emsp;&emsp;&emsp;&emsp;<label>Nomor Induk Kependudukan*</label>
                                <div class="form-group">
                                    <input type="text" name="id_karyawan" value="<?= $karyawan->id_karyawan ?>" pattern="[0-9]+" maxlength="4" class="form-control form-check-inline col-md-3" required>
                                    <input type="text" name="nik_karyawan" value="<?= $karyawan->nik_karyawan ?>" pattern="[0-9]+" maxlength="16" class="form-control form-check-inline col-md-6" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tmpt_lahir" value="<?= $karyawan->tmpt_lahir ?>" class="form-control form-check-inline col-md-3" required>
                                    <input type="date" name="tgl_lahir" value="<?= $karyawan->tgl_lahir ?>" class="form-control form-check-inline col-md-3" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>email</label>
                                    <input type="email" name="email_karyawan" value="<?= $karyawan->email_karyawan ?>" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>contact</label>
                        ...
                        <div class="card-body col-md-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="salary" id="salary" value="<?= $karyawan->salary ?>" class="form-control currency">
                                </div>
                            </div>
                            <div class="form-group">
...
<script>
    ...
    form.addEventListener("submit", function(event) {
        ...
        // seleksi input salary menggunakan ID
        var salaryInput = document.getElementById("salary");

        // ambil nilai input dari elemen input
        var splitValue = salaryInput.value.split(',');
        var parsedValue = parseInt(splitValue.join(''), 10);

        // set nilai input di dalam elemen input sehingga nantinya akan dikirim ke server
        salaryInput.value = parsedValue;
        form.submit();
    });
</script>
<?= $this->endSection() ?>